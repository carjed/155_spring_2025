...
-   **times**: See [this calendar](https://calendar.google.com/calendar/u/5?cid=Y19iZmU1MWU2MGYyY2U0MzQxZTY1MGE3YjUyNzI0NWUyNjRmMzg0MmQxNDVkNTY4NWMxNTEyMGVlNjM2MmQ5ZGEwQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20) (Tentatively from **10am-12pm and 1-2pm on Wednesdays** and **11:30am-12:30pm on Thursdays**).
...
-   Quiz 1: Thursday, 2/14. 1 hour in class.
-   Quiz 2: Thursday, 3/28. 1 hour in class. Will cover material from the first quiz to some extent because of the way that material in this course builds on earlier ideas.
...
You will not have the option to earn points back on the third quiz, due to time constraints at the end of the semester, so I encourage you to make use of this opportunity early on!

### Practice problems

There will be 8 practice problems throughout the course, building off of topics learned in videos/our in-class activities. Practice problems will be due on Wednesdays at 5pm. You are encouraged to work together on practice problems, but the work that you submit, including code, should be your own.
...
**Showing growth:** If, on a quiz, you demonstrate stronger understanding of the concepts you missed on a practice problem, you have the chance to earn points back on *up to two questions* on a single practice problem. Similarly to quiz corrections, you must:

-   Write a reflection of how the practice problem went for you, and where you felt strongest and more uncertain in your understanding before submitting the assignment.
-   Demonstrate an improved understanding of the concepts on the practice problem that you missed, referencing specific questions you answered correctly on the quiz.
-   Submit your practice problem corrections along with your reflection to the instructor, no later than one week after quizzes have been handed back.

You can do this 2 times over the semester (once for each of the first two quizzes), and you can show improvement on multiple practice problems using a single quiz. You cannot do this on the third quiz, due to time constraints at the end of the semester.
